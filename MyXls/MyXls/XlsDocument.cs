    ...
    public class XlsDocument
    {
        ...
        public string FileName
        {
            ...
            set
            {
                ...
                if (string.Compare(value.Substring(value.Length - 4), ".xls", StringComparison.CurrentCultureIgnoreCase) != 0)
        ...
        /// </summary>
		public Workbook Workbook { get { return _workbook; } internal set { _workbook = value;  } }
