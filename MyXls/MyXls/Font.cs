	...
	public class Font : ICloneable
	{
        /*
            ...
            fonts are referenced with one-based indexes.
                                                - excelfileformat.pdf, section 5.43 FONT
            ----------------------------------------------------------------------------
        */
...
#if SILVERLIGHT
                if (string.Compare(value, _fontName, StringComparison.InvariantCultureIgnoreCase) == 0)
#else
        ...
        internal Bytes Bytes
		{
			get
			{
				...
				bytes.Append(BitConverter.GetBytes(_doc.Workbook.Palette.GetIndex(_color)));
