...
namespace org.in2bits.MyOle2.Metadata
{
    ...
    public class Property
    {
        ...
        internal Bytes Bytes
        {
            ...
            {
                if (_value == null)
                    throw new Exception(string.Format("The Value of a Property can't be null - Property ID {0}", _id));
        ...
        private static Bytes GetBytes(Property property)
        {
            ...
            switch(property.Type)
            {
                ...
                default:
                    throw new Exception(string.Format("unexpected value {0}", property.Type));
            }
