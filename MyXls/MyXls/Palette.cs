...
namespace org.in2bits.MyXls
{
    ...
    internal class Palette
    {
		...
		internal Color GetColor(ushort index)
		{
			return index < _egaColors.Count ? (Color)_egaColors[index].Clone() : 
				index - _egaColors.Count < _colors.Count ? (Color)_colors[index - _egaColors.Count].Clone() :
				new Color(index);
		}
    }
}
